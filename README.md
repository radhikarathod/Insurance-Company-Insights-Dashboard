...
📌 Project Overview
This project analyzes insurance policy data to generate meaningful business insights using Power BI. The dashboard helps understand policy distribution, claim trends, customer demographics, and customer satisfaction through interactive visualizations.
The goal of this project is to demonstrate data analysis, data visualization, and business insight generation skills using real-world insurance datasets.

-----------------------------------------------------------------------------------------------------------------------------------------------------------
🎯 Objectives<br>
-- Analyze insurance premium and coverage trends<br>
-- Understand claim behavior and claim status distribution<br>
-- Identify customer demographics patterns<br>
-- Evaluate customer satisfaction using feedback ratings<br>
-- Build an interactive dashboard for business decision-making<br>

-----------------------------------------------------------------------------------------------------------------------------------------------------------
🗂 Dataset Description<br>

The dataset contains information related to:<br>
•	Policy details<br>
•	Customer demographics<br>
•	Coverage and premium amounts<br>
•	Claim details<br>
...
ClaimAmount - Amount requested in claim
